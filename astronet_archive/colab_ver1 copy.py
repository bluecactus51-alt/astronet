...
def train_astronet():
    ...
    train_loader = DataLoader(KeplerDataLoader('/content/astronet_data/train'), batch_size=64, shuffle=True, num_workers=4)
    val_loader = DataLoader(KeplerDataLoader('/content/astronet_data/val'), batch_size=64, shuffle=False, num_workers=4)
